...
/* package pg-dsl-0.1.0.0 */
#ifndef VERSION_pg_dsl
#define VERSION_pg_dsl "0.1.0.0"
#endif /* VERSION_pg_dsl */
#ifndef MIN_VERSION_pg_dsl
#define MIN_VERSION_pg_dsl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pg_dsl */
...
#define CURRENT_COMPONENT_ID "pg-dsl-0.1.0.0-inplace-pgdsl"
